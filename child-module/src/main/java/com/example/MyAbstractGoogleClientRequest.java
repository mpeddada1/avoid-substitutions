 ...
 * @author Yaniv Inbar
 */
public abstract class MyAbstractGoogleClientRequest<T> extends GenericData {
     ...
     */
    protected MyAbstractGoogleClientRequest(
    ...
    static class ApiClientVersion {
        ...
        public String toString() {
            // Native image substitution for version
     ...
     */
    public MyAbstractGoogleClientRequest<T> setDisableGZipContent(boolean disableGZipContent) {
     ...
     * @since 1.30
     */
    public MyAbstractGoogleClientRequest<T> setReturnRawInputStream(boolean returnRawInputStream) {
     ...
     * changing the return type, but nothing else.
     */
    public MyAbstractGoogleClientRequest<T> setRequestHeaders(HttpHeaders headers) {
    ...
    @Override
    public MyAbstractGoogleClientRequest<T> set(String fieldName, Object value) {
        return (MyAbstractGoogleClientRequest<T>) super.set(fieldName, value);
    }
